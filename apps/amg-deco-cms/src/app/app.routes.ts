  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'prestations',
        loadComponent: () =>
          import('./features/services-editor/services-editor.component').then(m => m.ServicesEditorComponent),
        title: 'Prestations — AMG Admin',
      },
      {
        path: 'avis-client',
        loadComponent: () => import('./features/avis-client/avis-client.component').then(m => m.AvisClientComponent),
        title: 'Avis clients — AMG Admin',
      },
      {
        path: 'comptes-externes',
        loadComponent: () =>
          import('./features/external-accounts/external-accounts.component').then(m => m.ExternalAccountsComponent),
