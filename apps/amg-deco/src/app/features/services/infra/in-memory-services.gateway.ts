...
const SERVICES_FALLBACK: Service[] = [
  {
    ...
    prices: [
      { id: '1-p1', service_id: '1', label: 'Forfait unique', price: 480, unit: undefined, order_index: 0 },
    ],
  ...
  },
  {
    ...
    prices: [
      { id: '3-p1', service_id: '3', label: 'Forfait par meuble', price: 400, unit: undefined, order_index: 0 },
    ],
  ...
  },
  {
    ...
    prices: [
      { id: '4-p1', service_id: '4', label: 'Par bien', price: 149, unit: undefined, order_index: 0 },
    ],
